...
<head>
    ...
    <title data-i18n="h1_title">Volume</title>
    <!-- Load Tailwind CSS -->
    ...
    <style>
        ...
        .outline-link { 
            ...
            /* ADJUESTED SIZE: Set to 1rem (16px) for Balangkas ng Modyul */
            font-size: 1rem; 
        }
        .outline-link:hover { 
        ...
        <main class="lg:col-span-9">
            <div id="main-content-wrapper" class="bg-white p-6 sm:p-10 rounded-2xl shadow-2xl border-t-4 border-l-4 border-green-600">
                ...
                <header class="text-center mb-10">
                    ...
                    <h1 class="main-title-h1 font-bold text-gray-900 mt-2" data-i18n="h1_title">Volume</h1>
                    ...
                    <details id="aralin2" class="module-section rounded-xl border border-gray-200 shadow-md overflow-hidden">
                        ...
                        <div class="content-box">
                            ...
                            <div class="example-box">
                                ...
                                <p class="math-formula" data-i18n="aralin2_ex1_math"> 10 mL &times; (1 tsp &divide; 5 mL) = <b>2 tsp</b> </p>
                            ...
                            <div class="example-box">
                                ...
                                <p class="math-formula" data-i18n="aralin2_ex2_math"> (3 &divide; 4) &times; 1,000 mL = <b>750 mL</b> </p>
                        ...
                        <div class="space-y-4 p-4 border rounded-lg bg-white">
                            ...
                            <div class="flex flex-col space-y-4">
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <input type="text" id="qa1" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qa1_placeholder" placeholder="Answer (mL)">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qa2" class="font-medium" data-i18n="qa2_label">2. How many Liters (L) are in 4,700 Milliliters (mL)?</label>
                                    <input type="text" id="qa2" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qa2_placeholder" placeholder="Answer (L)">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qa3" class="font-medium" data-i18n="qa3_label">3. How many Milliliters (mL) are in 12 fluid ounces (fl. oz.)?</label>
                                    <input type="text" id="qa3" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qa3_placeholder" placeholder="Answer (mL)">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qa4" class="font-medium" data-i18n="qa4_label">4. How many Pints (pt) are equivalent to 1 Gallon (gal)?</label>
                                    <input type="text" id="qa4" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qa4_placeholder" placeholder="Answer (pt)">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qa5" class="font-medium" data-i18n="qa5_label">5. How many Milliliters (mL) are in 7 Teaspoon (tsp)? (1 tsp = 5 mL)</label>
                                    <input type="text" id="qa5" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qa5_placeholder" placeholder="Answer (mL)">
                                </div>
                            </div>
                        </div>

                        <div class="space-y-4 p-4 border rounded-lg bg-white">
                            <p class="font-semibold text-lg text-gray-800 border-b pb-2" data-i18n="quiz_section_b">B. Find the Quantity and the Better Buy (A or B)</p>
                            <div class="flex flex-col space-y-4">
                                <div class="flex flex-col space-y-2">
                                    <label for="qa6" class="font-medium" data-i18n="qa6_label">6. How many Liters (L) are in 1.5 Gallons (gal)? (1 gal = 3.8 L)</label>
                                    <input type="text" id="qa6" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qa6_placeholder" placeholder="Answer (L)">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qb1" class="font-medium" data-i18n="qb1_label">7. Which is the better buy: <b>350 mL</b> ₱10.50 (A) or <b>12 fl. oz.</b> ₱7.20 (B)?</label>
                                    <input type="text" id="qb1" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qb1_placeholder" placeholder="A or B">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qb2" class="font-medium" data-i18n="qb2_label">8. Which is the better buy: <b>2 L</b> ₱38.00 (A) or <b>1/2 Gallon</b> ₱35.00 (B)?</label>
                                    <input type="text" id="qb2" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qb2_placeholder" placeholder="A or B">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qb3" class="font-medium" data-i18n="qb3_label">9. Which is cheaper: <b>470 mL</b> ₱25.00 (A) or <b>1 Pint</b> ₱20.00 (B)?</label>
                                    <input type="text" id="qb3" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qb3_placeholder" placeholder="A or B">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="qb4" class="font-medium" data-i18n="qb4_label">10. Which is cheaper: <b>10 L</b> ₱50.00 (A) or <b>3 Gallons</b> ₱120.00 (B)?</label>
                                    <input type="text" id="qb4" class="quiz-input w-full sm:w-64" data-i18n-placeholder="qb4_placeholder" placeholder="A or B">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        const translations = {
            en: {
                ...
                qa5_label: "5. How many Milliliters (mL) are in 7 Teaspoon (tsp)? (1 tsp = 5 mL)",
                qa6_label: "6. How many Liters (L) are in 1.5 Gallons (gal)? (1 gal = 3.8 L)",
                qa1_placeholder: "Answer (mL)",
                qa2_placeholder: "Answer (L)",
                qa3_placeholder: "Answer (mL)",
                qa4_placeholder: "Answer (pt)",
                qa5_placeholder: "Answer (mL)",
                qa6_placeholder: "Answer (L)",

                quiz_section_b: "B. Find the Quantity and the Better Buy (A or B)",
                qb1_label: "7. Which is the better buy: <b>350 mL</b> ₱10.50 (A) or <b>12 fl. oz.</b> ₱7.20 (B)?",
                qb2_label: "8. Which is the better buy: <b>2 L</b> ₱38.00 (A) or <b>1/2 Gallon</b> ₱35.00 (B)?",
                qb3_label: "9. Which is cheaper: <b>470 mL</b> ₱25.00 (A) or <b>1 Pint</b> ₱20.00 (B)?",
                qb4_label: "10. Which is cheaper: <b>10 L</b> ₱50.00 (A) or <b>3 Gallons</b> ₱120.00 (B)?",
                qb1_placeholder: "A or B",
                qb2_placeholder: "A or B",
                qb3_placeholder: "A or B",
                qb4_placeholder: "A or B",
            ...
            tl: {
                ...
                outline_aralin2: "Aralin 2: Magkasingdami Ba? (Conversion ng Yunit)",
                outline_aralin3: "Aralin 3: Alin ang Mas Nararapat Bilhin?",
                ...
                // Lesson 2 Content (Conversion)
                aralin2_title: "Aralin 2: Magkasingdami Ba? (Conversion ng Yunit)",
                ...
                aralin2_table_row4: "<td>1 pint (pt)</td><td>470 milliliters (mL)</td>",
                aralin2_table_row5: "<td>1 quart (qt)</td><td>950 milliliters (mL)</td>",
                aralin2_table_row6: "<td>1 galon (gal)</td><td>3.8 liters (L)</td>",
                ...
                // Lesson 3 Content (Better Buy)
                aralin3_title: "Aralin 3: Alin ang Mas Nararapat Bilhin? (Unit Cost)",
                ...
                aralin3_ex_b: "<b>Produkto B:</b> 1.9 Litro (1/2 galon) ₱35.00",
                ...
                qa4_label: "4. Ilang Pint (pt) ang katumbas ng 1 Galon (gal)?",
                qa5_label: "5. Ilang Mililitro (mL) ang 7 Teaspoon (tsp)? (1 tsp = 5 mL)",
                qa6_label: "6. Ilang Litro (L) ang 1.5 Galon (gal)? (1 gal = 3.8 L)",
                qa1_placeholder: "Sagot (mL)",
                qa2_placeholder: "Sagot (L)",
                qa3_placeholder: "Sagot (mL)",
                qa4_placeholder: "Sagot (pt)",
                qa5_placeholder: "Sagot (mL)",
                qa6_placeholder: "Sagot (L)",

                quiz_section_b: "B. Hanapin ang Dami at ang Mas Sulit Bilhin (A o B)",
                qb1_label: "7. Alin ang mas sulit bilhin: <b>350 mL</b> ₱10.50 (A) o <b>12 fl. oz.</b> ₱7.20 (B)?",
                qb2_label: "8. Alin ang mas sulit bilhin: <b>2 L</b> ₱38.00 (A) o <b>1/2 Galon</b> ₱35.00 (B)?",
                qb3_label: "9. Alin ang mas mura: <b>470 mL</b> ₱25.00 (A) o <b>1 Pint</b> ₱20.00 (B)?",
                qb4_label: "10. Alin ang mas mura: <b>10 L</b> ₱50.00 (A) o <b>3 Galon</b> ₱120.00 (B)?",
                qb1_placeholder: "A o B",
                qb2_placeholder: "A o B",
                qb3_placeholder: "A o B",
                qb4_placeholder: "A o B",
        ...
        function standardizeText(value) {
            ...
            // Allow 'A' or 'B' case-insensitive comparison, stripped of everything else
            return value.trim().toLowerCase().replace(/[^ab]/g, ''); 
        }
        ...
        function submitQuiz(isLanguageToggle = false) {
            let correctCount = 0;
            // REMOVED: const totalQuestions = 10; 
            const resultsDiv = document.getElementById('results');
            ...
            const answers = {
                ...
                qa4: 8,
                // A5: 7 Teaspoon (tsp) to mL (7 * 5 mL/tsp = 35)
                qa5: 35, 
                // A6: 1.5 Galon to L (1.5 * 3.8 L/gal = 5.7)
                qa6: 5.7, 
                // B1/Q7: 350 mL @ P10.50 (A) vs 12 fl oz (360 mL) @ P7.20 (B) -> B is cheaper (0.020 < 0.030)
                qb1: 'B',
                // B2/Q8: 2 L @ P38.00 (A) vs 1/2 Galon (1.9 L) @ P35.00 (B) -> B is cheaper (18.42 < 19.00)
                qb2: 'B', 
                // B3/Q9: 470 mL P25.00 (A) vs 1 Pint (470 mL) P20.00 (B) -> B is cheaper
                qb3: 'B',
                // B4/Q10: 10 L P50.00 (A) vs 3 Galon (11.4 L) P120.00 (B) -> A is cheaper (5.00 < 10.53)
                qb4: 'A',
            };
            
            // Calculate total questions once here.
            ...
            if (!isLanguageToggle) {
                ...
                correctCount += checkAnswer('qa5', answers.qa5, false, 0); // Whole number
                correctCount += checkAnswer('qa6', answers.qa6, false, 1); // 1 decimal place
                ...
                correctCount += checkAnswer('qb3', answers.qb3, true); // Strict text check
                correctCount += checkAnswer('qb4', answers.qb4, true); // Strict text check
