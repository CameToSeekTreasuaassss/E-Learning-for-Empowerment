...
<head>
    ...
    <title>Pagsusulit: Pagdaragdag at Pagbabawas ng Praksiyon</title>
...
<body class="bg-primary-light min-h-screen flex items-center justify-center py-8 font-sans">
    ...
    <div id="quiz-container" class="w-full p-4 sm:p-8" style="max-width: 92rem;">
        <header class="mb-4 relative">
            ...
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-primary mb-2" id="quiz-title">Pagsusulit: Pagdaragdag at Pagbabawas ng Praksiyon</h1>
                <p class="text-xl text-gray-600" id="quiz-subtitle">30 Items: Konsepto, Pagdaragdag, at Pagbabawas</p>
            </div>
    ...
    <script>
        ...
        const uiText = {
            'quizTitle': { tl: "Pagsusulit: Pagdaragdag at Pagbabawas ng Praksiyon", en: "Quiz: Addition and Subtraction of Fractions" },
            'quizSubtitle': { tl: "30 Items: Konsepto, Pagdaragdag, at Pagbabawas", en: "30 Items: Concepts, Addition, and Subtraction" },
            'goBack': { tl: 'Bumalik', en: 'Go Back' },
            'section1Title': { tl: 'I. Konsepto at Pagpapantay ng Praksiyon', en: 'I. Concepts and Fraction Equivalence' },
            'section2Title': { tl: 'II. Pagdaragdag ng Praksiyon', en: 'II. Addition of Fractions' },
            'section3Title': { tl: 'III. Pagbabawas ng Praksiyon', en: 'III. Subtraction of Fractions' },
        ...
        const quizData = [
            ...
            { 
                question: { tl: "Sa praksiyong 3/5, anong bahagi ang tinatawag na <b>numerator</b>?", en: "In the fraction 3/5, what part is called the <b>numerator</b>?" }, 
                options: { tl: ["Ang ibabang bilang", "Ang gitnang linya", "Ang itaas na bilang", "Ang buong bilang"], en: ["The bottom number", "The middle line", "The top number", "The whole number"] }, 
                answer: 2, topic: 'Fraction Parts' 
            },
            { 
                question: { tl: "Ang praksiyong 7/4 ay isang halimbawa ng anong uri ng praksiyon?", en: "The fraction 7/4 is an example of what type of fraction?" }, 
                options: { tl: ["Proper fraction", "Mixed number", "Improper fraction", "Unit fraction"], en: ["Proper fraction", "Mixed number", "Improper fraction", "Unit fraction"] }, 
                answer: 2, topic: 'Fraction Types' 
            },
            { 
                question: { tl: "Ang 1/2 at 2/4 ay magkatumbas. Ano ang tawag sa mga ito?", en: "1/2 and 2/4 are equal. What are they called?" }, 
                options: { tl: ["Simple fractions", "Equivalent fractions", "Unit fractions", "Complex fractions"], en: ["Simple fractions", "Equivalent fractions", "Unit fractions", "Complex fractions"] }, 
                answer: 1, topic: 'Equivalence' 
            },
            { 
                question: { tl: "Ano ang pinakasimpleng anyo ng praksiyong 6/8?", en: "What is the simplest form of the fraction 6/8?" }, 
                options: { tl: ["2/4", "3/4", "1/2", "6/8"], en: ["2/4", "3/4", "1/2", "6/8"] }, 
                answer: 1, topic: 'Simplifying' 
            },
            { 
                question: { tl: "Ang 3/4 ay anong uri ng praksiyon?", en: "What type of fraction is 3/4?" }, 
                options: { tl: ["Improper fraction", "Mixed number", "Proper fraction", "Whole number"], en: ["Improper fraction", "Mixed number", "Proper fraction", "Whole number"] }, 
                answer: 2, topic: 'Fraction Types' 
            },
            { 
                question: { tl: "Ano ang katumbas na mixed number ng 9/2?", en: "What is the equivalent mixed number of 9/2?" }, 
                options: { tl: ["4 1/4", "2 1/2", "4 1/2", "9 1/2"], en: ["4 1/4", "2 1/2", "4 1/2", "9 1/2"] }, 
                answer: 2, topic: 'Improper to Mixed' 
            },
            { 
                question: { tl: "Ano ang katumbas na improper fraction ng 2 1/3?", en: "What is the equivalent improper fraction of 2 1/3?" }, 
                options: { tl: ["7/3", "6/3", "5/3", "8/3"], en: ["7/3", "6/3", "5/3", "8/3"] }, 
                answer: 0, topic: 'Mixed to Improper' 
            },
            { 
                question: { tl: "Alin sa mga sumusunad ang pinakamalaking praksiyon?", en: "Which of the following is the largest fraction?" }, 
                options: { tl: ["1/2", "1/4", "3/4", "1/8"], en: ["1/2", "1/4", "3/4", "1/8"] }, 
                answer: 2, topic: 'Comparing Fractions' 
            },
            { 
                question: { tl: "Ano ang kailangan mong hanapin bago ka makapagdagdag ng 1/3 + 1/6?", en: "What do you need to find before you can add 1/3 + 1/6?" }, 
                options: { tl: ["Numerator", "Difference", "LCD (Least Common Denominator)", "Sum"], en: ["Numerator", "Difference", "LCD (Least Common Denominator)", "Sum"] }, 
                answer: 2, topic: 'Addition Concept' 
            },
            { 
                question: { tl: "Sa praksiyong 4/7, anong bahagi ang tinatawag na <b>denominator</b>?", en: "In the fraction 4/7, what part is called the <b>denominator</b>?" }, 
                options: { tl: ["Ang gitnang linya", "Ang buong bilang", "Ang itaas na bilang", "Ang ibabang bilang"], en: ["The middle line", "The whole number", "The top number", "The bottom number"] }, 
                answer: 3, topic: 'Fraction Parts' 
            },

            // Section II: Pagdaragdag ng Praksiyon (11-20)
            { 
                question: { tl: "Idagdag: 1/5 + 2/5", en: "Add: 1/5 + 2/5" }, 
                options: { tl: ["1/5", "2/5", "3/5", "3/10"], en: ["1/5", "2/5", "3/5", "3/10"] }, 
                answer: 2, topic: 'Addition (Same Denominator)' 
            },
            { 
                question: { tl: "Idagdag at i-simplify: 3/8 + 1/8", en: "Add and simplify: 3/8 + 1/8" }, 
                options: { tl: ["4/8", "1/4", "1/2", "4/16"], en: ["4/8", "1/4", "1/2", "4/16"] }, 
                answer: 2, topic: 'Addition & Simplify' 
            },
            { 
                question: { tl: "Idagdag: 1/2 + 1/4", en: "Add: 1/2 + 1/4" }, 
                options: { tl: ["2/6", "3/4", "1/4", "2/8"], en: ["2/6", "3/4", "1/4", "2/8"] }, 
                answer: 1, topic: 'Addition (Different Denominator)' 
            },
            { 
                question: { tl: "Idagdag at ibigay ang sagot sa mixed number: 1/3 + 5/6", en: "Add and give the answer as a mixed number: 1/3 + 5/6" }, 
                options: { tl: ["6/9", "1 1/6", "1 1/3", "7/6"], en: ["6/9", "1 1/6", "1 1/3", "7/6"] }, 
                answer: 1, topic: 'Addition (Improper Result)' 
            },
            { 
                question: { tl: "Idagdag: 2/3 + 1/3", en: "Add: 2/3 + 1/3" }, 
                options: { tl: ["3/6", "1/3", "1", "1 1/3"], en: ["3/6", "1/3", "1", "1 1/3"] }, 
                answer: 2, topic: 'Addition (Equals Whole)' 
            },
            { 
                question: { tl: "Idagdag: 1 1/4 + 2 1/4", en: "Add: 1 1/4 + 2 1/4" }, 
                options: { tl: ["3 2/8", "3 1/2", "4 1/4", "3 1/4"], en: ["3 2/8", "3 1/2", "4 1/4", "3 1/4"] }, 
                answer: 1, topic: 'Addition (Mixed Numbers)' 
            },
            { 
                question: { tl: "Idagdag: 1/2 + 3/8", en: "Add: 1/2 + 3/8" }, 
                options: { tl: ["4/10", "4/8", "7/8", "5/8"], en: ["4/10", "4/8", "7/8", "5/8"] }, 
                answer: 2, topic: 'Addition (Different Denominator)' 
            },
            { 
                question: { tl: "Idagdag: 2 + 3/5", en: "Add: 2 + 3/5" }, 
                options: { tl: ["5/5", "2 3/5", "2 1/5", "3 2/5"], en: ["5/5", "2 3/5", "2 1/5", "3 2/5"] }, 
                answer: 1, topic: 'Addition (Whole & Fraction)' 
            },
            { 
                question: { tl: "May 1/4 na saging si Ana at 1/4 na saging si Ben. Ilan lahat?", en: "Ana has 1/4 of a banana and Ben has 1/4 of a banana. How much do they have in total?" }, 
                options: { tl: ["2/8", "1/2", "2/4", "3/4"], en: ["2/8", "1/2", "2/4", "3/4"] }, 
                answer: 1, topic: 'Addition Word Problem' 
            },
            { 
                question: { tl: "Idagdag: 1 2/5 + 4/5", en: "Add: 1 2/5 + 4/5" }, 
                options: { tl: ["2 1/5", "1 6/5", "2 4/5", "1 1/5"], en: ["2 1/5", "1 6/5", "2 4/5", "1 1/5"] }, 
                answer: 0, topic: 'Addition (Mixed & Improper)' 
            },

            // Section III: Pagbabawas ng Praksiyon (21-30)
            { 
                question: { tl: "Ibawas: 4/5 - 1/5", en: "Subtract: 4/5 - 1/5" }, 
                options: { tl: ["5/5", "3/5", "3/10", "4/5"], en: ["5/5", "3/5", "3/10", "4/5"] }, 
                answer: 1, topic: 'Subtraction (Same Denominator)' 
            },
            { 
                question: { tl: "Ibawas at i-simplify: 7/8 - 3/8", en: "Subtract and simplify: 7/8 - 3/8" }, 
                options: { tl: ["1/2", "4/8", "1/4", "3/4"], en: ["1/2", "4/8", "1/4", "3/4"] }, 
                answer: 0, topic: 'Subtraction & Simplify' 
            },
            { 
                question: { tl: "Ibawas: 3/4 - 1/2", en: "Subtract: 3/4 - 1/2" }, 
                options: { tl: ["2/4", "1/4", "2/2", "1/8"], en: ["2/4", "1/4", "2/2", "1/8"] }, 
                answer: 1, topic: 'Subtraction (Different Denominator)' 
            },
            { 
                question: { tl: "Ibawas: 1 - 3/4", en: "Subtract: 1 - 3/4" }, 
                options: { tl: ["2/4", "1/2", "1/4", "3/4"], en: ["2/4", "1/2", "1/4", "3/4"] }, 
                answer: 2, topic: 'Subtraction (From Whole)' 
            },
            { 
                question: { tl: "Ibawas: 3 2/3 - 1 1/3", en: "Subtract: 3 2/3 - 1 1/3" }, 
                options: { tl: ["2 1/3", "3 1/3", "2 3/3", "1 2/3"], en: ["2 1/3", "3 1/3", "2 3/3", "1 2/3"] }, 
                answer: 0, topic: 'Subtraction (Mixed Numbers)' 
            },
            { 
                question: { tl: "Ibawas: 2 - 1/5", en: "Subtract: 2 - 1/5" }, 
                options: { tl: ["1 4/5", "2 1/5", "1 1/5", "4/5"], en: ["1 4/5", "2 1/5", "1 1/5", "4/5"] }, 
                answer: 0, topic: 'Subtraction (Whole & Fraction)' 
            },
            { 
                question: { tl: "Ibawas at i-simplify: 5/6 - 1/3", en: "Subtract and simplify: 5/6 - 1/3" }, 
                options: { tl: ["4/6", "3/6", "1/2", "2/3"], en: ["4/6", "3/6", "1/2", "2/3"] }, 
                answer: 2, topic: 'Subtraction & Simplify' 
            },
            { 
                question: { tl: "Si Maya ay may 2 1/4 metro ng laso. Ginupit niya ang 1 metro. Ilan ang natira?", en: "Maya has 2 1/4 meters of ribbon. She cut 1 meter. How much is left?" }, 
                options: { tl: ["1 2/4 metro", "1 1/4 metro", "3/4 metro", "2 1/4 metro"], en: ["1 2/4 meters", "1 1/4 meters", "3/4 meters", "2 1/4 meters"] }, 
                answer: 1, topic: 'Subtraction Word Problem' 
            },
            { 
                question: { tl: "Ibawas: 1 1/2 - 3/4", en: "Subtract: 1 1/2 - 3/4" }, 
                options: { tl: ["1/2", "3/4", "1 1/4", "2/4"], en: ["1/2", "3/4", "1 1/4", "2/4"] }, 
                answer: 1, topic: 'Subtraction (Borrowing)' 
            },
            { 
                question: { tl: "Ibawas: 9/10 - 3/5", en: "Subtract: 9/10 - 3/5" }, 
                options: { tl: ["6/10", "3/10", "6/5", "12/10"], en: ["6/10", "3/10", "6/5", "12/10"] }, 
                answer: 1, topic: 'Subtraction (Different Denominator)' 
            }
        ];

        let userAnswers = {}; // {qIndex: selectedOptionIndex}
        const quizName = "Pagsusulit: Pagdaragdag at Pagbabawas ng Praksiyon";
