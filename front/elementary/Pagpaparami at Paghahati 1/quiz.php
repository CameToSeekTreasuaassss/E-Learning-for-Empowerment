...
<head>
    ...
    <title>Pagsusulit: Pagpaparami at Paghahati 1</title>
...
<body class="bg-primary-light min-h-screen flex items-center justify-center py-8 font-sans">
    ...
    <div id="quiz-container" class="w-full p-4 sm:p-8" style="max-width: 92rem;">
        <header class="mb-4 relative">
            ...
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-primary mb-2" id="quiz-title">Pagsusulit: Pagpaparami at Paghahati</h1>
                <p class="text-xl text-gray-600" id="quiz-subtitle">30 Items: Basic Facts at Word Problems</p>
            </div>
        ...
        <div id="results-modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-80 flex items-center justify-center p-4 z-50">
            <div class="bg-white card rounded-xl w-full max-w-md p-8 text-center shadow-2xl">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Removing inline onclick as saving is now handled in submitQuiz -->
    ...
    <script>
        ...
        const uiText = {
            'quizTitle': { tl: "Pagsusulit: Pagpaparami at Paghahati", en: "Quiz: Multiplication and Division" },
            'quizSubtitle': { tl: "30 Items: Basic Facts at Word Problems", en: "30 Items: Basic Facts and Word Problems" },
            'goBack': { tl: 'Bumalik', en: 'Go Back' },
            'section1Title': { tl: 'I. Pagpaparami (Multiplication)', en: 'I. Multiplication (Basic Facts)' },
            'section2Title': { tl: 'II. Paghahati (Division)', en: 'II. Division (Basic Facts)' },
        ...
        const quizData = [
            // Section I: Pagpaparami (Multiplication) - Basic Facts (1-10)
            { 
                question: { tl: "3 x 6 = ?", en: "3 x 6 = ?" }, 
                options: { tl: ["9", "15", "18", "21"], en: ["9", "15", "18", "21"] }, 
                answer: 2, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "7 x 8 = ?", en: "7 x 8 = ?" }, 
                options: { tl: ["48", "54", "56", "63"], en: ["48", "54", "56", "63"] }, 
                answer: 2, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "2 x 9 = ?", en: "2 x 9 = ?" }, 
                options: { tl: ["16", "18", "20", "11"], en: ["16", "18", "20", "11"] }, 
                answer: 1, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "5 x 0 = ?", en: "5 x 0 = ?" }, 
                options: { tl: ["5", "1", "10", "0"], en: ["5", "1", "10", "0"] }, 
                answer: 3, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "6 x 1 = ?", en: "6 x 1 = ?" }, 
                options: { tl: ["0", "6", "1", "7"], en: ["0", "6", "1", "7"] }, 
                answer: 1, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "9 x 3 = ?", en: "9 x 3 = ?" }, 
                options: { tl: ["18", "27", "21", "30"], en: ["18", "27", "21", "30"] }, 
                answer: 1, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "8 x 2 = ?", en: "8 x 2 = ?" }, 
                options: { tl: ["10", "12", "14", "16"], en: ["10", "12", "14", "16"] }, 
                answer: 3, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "4 x 4 = ?", en: "4 x 4 = ?" }, 
                options: { tl: ["8", "12", "16", "20"], en: ["8", "12", "16", "20"] }, 
                answer: 2, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "6 x 9 = ?", en: "6 x 9 = ?" }, 
                options: { tl: ["45", "48", "54", "63"], en: ["45", "48", "54", "63"] }, 
                answer: 2, topic: 'Pagpaparami' 
            },
            { 
                question: { tl: "7 x 7 = ?", en: "7 x 7 = ?" }, 
                options: { tl: ["42", "49", "56", "64"], en: ["42", "49", "56", "64"] }, 
                answer: 1, topic: 'Pagpaparami' 
            },

            // Section II: Paghahati (Division) - Basic Facts (11-20)
            { 
                question: { tl: "56 ÷ 8 = ?", en: "56 ÷ 8 = ?" }, 
                options: { tl: ["6", "7", "8", "9"], en: ["6", "7", "8", "9"] }, 
                answer: 1, topic: 'Paghahati' 
            },
            { 
                question: { tl: "9 ÷ 9 = ?", en: "9 ÷ 9 = ?" }, 
                options: { tl: ["9", "0", "1", "18"], en: ["9", "0", "1", "18"] }, 
                answer: 2, topic: 'Paghahati' 
            },
            { 
                question: { tl: "8 ÷ 1 = ?", en: "8 ÷ 1 = ?" }, 
                options: { tl: ["1", "0", "8", "9"], en: ["1", "0", "8", "9"] }, 
                answer: 2, topic: 'Paghahati' 
            },
            { 
                question: { tl: "45 ÷ 5 = ?", en: "45 ÷ 5 = ?" }, 
                options: { tl: ["7", "8", "9", "5"], en: ["7", "8", "9", "5"] }, 
                answer: 2, topic: 'Paghahati' 
            },
            { 
                question: { tl: "72 ÷ 9 = ?", en: "72 ÷ 9 = ?" }, 
                options: { tl: ["7", "8", "9", "6"], en: ["7", "8", "9", "6"] }, 
                answer: 1, topic: 'Paghahati' 
            },
            { 
                question: { tl: "40 ÷ 8 = ?", en: "40 ÷ 8 = ?" }, 
                options: { tl: ["4", "5", "6", "8"], en: ["4", "5", "6", "8"] }, 
                answer: 1, topic: 'Paghahati' 
            },
            { 
                question: { tl: "36 ÷ 6 = ?", en: "36 ÷ 6 = ?" }, 
                options: { tl: ["6", "7", "8", "9"], en: ["6", "7", "8", "9"] }, 
                answer: 0, topic: 'Paghahati' 
            },
            { 
                question: { tl: "24 ÷ 3 = ?", en: "24 ÷ 3 = ?" }, 
                options: { tl: ["6", "7", "8", "9"], en: ["6", "7", "8", "9"] }, 
                answer: 2, topic: 'Paghahati' 
            },
            { 
                question: { tl: "35 ÷ 7 = ?", en: "35 ÷ 7 = ?" }, 
                options: { tl: ["4", "5", "6", "7"], en: ["4", "5", "6", "7"] }, 
                answer: 1, topic: 'Paghahati' 
            },
            { 
                question: { tl: "28 ÷ 4 = ?", en: "28 ÷ 4 = ?" }, 
                options: { tl: ["6", "7", "8", "9"], en: ["6", "7", "8", "9"] }, 
                answer: 1, topic: 'Paghahati' 
            },
            
            // Section III: Word Problems (21-30) - Extended to 10 questions
            { 
                question: { tl: "Magkano ang kinita ni Aling Nora sa 23 pakete ng tuyo na nagkakahalaga ng P4 bawat isa? (23 x 4)", en: "How much did Aling Nora earn from 23 packs of dried fish worth P4 each? (23 x 4)" }, 
                options: { tl: ["P82", "P90", "P92", "P88"], en: ["P82", "P90", "P92", "P88"] }, 
                answer: 2, topic: 'Word Problem (Multiplication)' 
            },
            { 
                question: { tl: "Ilang rosas mayroon si Amelia kung may 13 paso siya na may 7 bulaklak bawat isa? (13 x 7)", en: "How many roses does Amelia have if she has 13 pots with 7 flowers each? (13 x 7)" }, 
                options: { tl: ["81", "91", "101", "71"], en: ["81", "91", "101", "71"] }, 
                answer: 1, topic: 'Word Problem (Multiplication)' 
            },
            { 
                question: { tl: "Hinati ni Lolo Ambo ang 32 hektaryang lupain sa 4 na anak. Ilang hektarya ang nakuha ng bawat isa? (32 ÷ 4)", en: "Lolo Ambo divided 32 hectares of land among 4 children. How many hectares did each child receive? (32 ÷ 4)" }, 
                options: { tl: ["6", "7", "8", "9"], en: ["6", "7", "8", "9"] }, 
                answer: 2, topic: 'Word Problem (Division)' 
            },
            { 
                question: { tl: "Magkano ang kinita ni Mang Nestor sa isang biyahe kung may 18 pasahero at P4 ang bayad ng bawat isa? (18 x 4)", en: "How much did Mang Nestor earn in one trip if he had 18 passengers and the fare was P4 each? (18 x 4)" }, 
                options: { tl: ["P62", "P72", "P82", "P76"], en: ["P62", "P72", "P82", "P76"] }, 
                answer: 1, topic: 'Word Problem (Multiplication)' 
            },
            { 
                question: { tl: "Ilang biyahe ang kakailanganin ni Mang Cario para madala ang 24 sako ng bigas kung 4 na sako lang ang kasya sa tricycle? (24 ÷ 4)", en: "How many trips will Mang Cario need to transport 24 sacks of rice if only 4 sacks fit in the tricycle? (24 ÷ 4)" }, 
                options: { tl: ["5", "6", "7", "8"], en: ["5", "6", "7", "8"] }, 
                answer: 1, topic: 'Word Problem (Division)' 
            },
            { 
                question: { tl: "Si Aling Marta ay nagprito ng 12 galunggong para sa kanyang 6 na anak. Ilang galunggong ang nakuha ng bawat anak? (12 ÷ 6)", en: "Aling Marta fried 12 round scads (galunggong) for her 6 children. How many round scads did each child receive? (12 ÷ 6)" }, 
                options: { tl: ["2", "3", "4", "6"], en: ["2", "3", "4", "6"] }, 
                answer: 0, topic: 'Word Problem (Division)' 
            },
            { 
                question: { tl: "Si Gng. Perez ay may 3 anak. Binigyan niya ang bawat isa ng 15 piso. Magkano lahat ang ibinigay niya? (15 x 3)", en: "Mrs. Perez has 3 children. She gave each child 15 pesos. How much did she give in total? (15 x 3)" }, 
                options: { tl: ["P35", "P40", "P45", "P50"], en: ["P35", "P40", "P45", "P50"] }, 
                answer: 2, topic: 'Word Problem (Multiplication)' 
            },
            { 
                question: { tl: "Si Aling Carmen ay nagbebenta ng mangga. Ang isang bag ay P30 at may 5 mangga. Magkano ang halaga ng bawat mangga? (30 ÷ 5)", en: "Aling Carmen sells mangoes. One bag costs P30 and contains 5 mangoes. What is the cost of each mango? (30 ÷ 5)" }, 
                options: { tl: ["P5", "P6", "P7", "P8"], en: ["P5", "P6", "P7", "P8"] }, 
                answer: 1, topic: 'Word Problem (Division)' 
            },
            { 
                question: { tl: "Bumili si Aling Dolor ng 4 na pakete ng kalamansi. Ang bawat pakete ay may 17 piraso. Ilang lahat ang kalamansi? (17 x 4)", en: "Aling Dolor bought 4 packs of calamansi. Each pack has 17 pieces. How many calamansi are there in total? (17 x 4)" }, 
                options: { tl: ["64", "68", "72", "78"], en: ["64", "68", "72", "78"] }, 
                answer: 1, topic: 'Word Problem (Multiplication)' 
            },
            { 
                question: { tl: "May 12 pangkat na sasali sa paligsahan. Ang bawat pangkat ay may 5 kasapi. Ilan lahat ang sasali? (12 x 5)", en: "There are 12 teams joining the contest. Each team has 5 members. How many participants are there in total? (12 x 5)" }, 
                options: { tl: ["50", "55", "60", "65"], en: ["50", "55", "60", "65"] }, 
                answer: 2, topic: 'Word Problem (Multiplication)' 
            }
        ];

        let userAnswers = {}; // {qIndex: selectedOptionIndex}
        const quizName = "Pagsusulit: Pagpaparami at Paghahati 1";
