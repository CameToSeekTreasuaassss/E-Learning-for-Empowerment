...
<head>
    ...
    <title>Pagsusulit: Pagsukat ng Bolyum</title>
...
<body class="bg-primary-light min-h-screen flex items-center justify-center py-8 font-sans">
    ...
    <div id="quiz-container" class="w-full p-4 sm:p-8" style="max-width: 92rem;">
        <header class="mb-4 relative">
            ...
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-primary mb-2" id="quiz-title">Pagsusulit: Pagsukat ng Bolyum (Volume)</h1>
        ...
        <div id="results-modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-80 flex items-center justify-center p-4 z-50">
            <div class="bg-white card rounded-xl w-full max-w-md p-8 text-center shadow-2xl">
                ...
                <div class="space-y-3">
                    <!-- REMOVED onclick and updated text for dual storage -->
    ...
    <script>
        ...
        const uiText = {
            'quizTitle': { tl: "Pagsusulit: Pagsukat ng Bolyum (Volume)", en: "Quiz: Measurement of Volume" },
        ...
        const quizData = [
            ...
            { 
                ...
                answer: 2, topic: 'Comparison (L to mL bottles)' 
            },
            // Q19: 2,500 mL to L
            { 
            ...
            { 
                ...
                answer: 1, topic: 'Comparison (gal vs qt)' 
            },
            ...
            // Q30: Better Buy (350 mL @ P10.50 -> P0.03/mL vs 12 fl. oz @ P7.20 -> P0.02/mL)
            { 
                question: { tl: "Alin ang 'better buy'? (350 mL bote sa ₱10.50 o 12 fl. oz. (360 mL) bote sa ₱7.20)?", en: "Which is the 'better buy'? (350 mL bottle for ₱10.50 or 12 fl. oz. (360 mL) bottle for ₱7.20)?" }, 
                options: { tl: ["350 mL bote", "12 fl. oz. bote", "Pareho lang ang cost per unit", "Wala sa nabanggit"], en: ["350 mL bottle", "12 fl. oz. bottle", "The cost per unit is the same", "None of the above"] }, 
                answer: 1, topic: 'Better Buy (mL vs oz)' 
            } 
        ];

        let userAnswers = {}; // {qIndex: selectedOptionIndex}
        const quizName = "Pagsusulit: Pagsukat ng Bolyum";
